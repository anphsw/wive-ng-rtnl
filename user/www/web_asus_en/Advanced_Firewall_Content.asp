...
<td class="content_header_td" onMouseOver="return overlib('<#FirewallConfig_LanWanICMP_itemdesc#>', LEFT);" onMouseOut="return nd();"><#FirewallConfig_LanWanICMP_itemname#>
           </td><td class="content_input_td"><input type="text" maxlength="32" class="content_input_fd" size="32" name="filter_lw_icmp_x" onChange="page_changed()" value="<% nvram_get_x("FirewallConfig","filter_lw_icmp_x"); %>" onBlur="return validate_portlist(this, 'filter_lw_icmp_x')" onKeyPress="return is_portlist(this)"></td>
</tr>
</table>
</td>
</tr>
