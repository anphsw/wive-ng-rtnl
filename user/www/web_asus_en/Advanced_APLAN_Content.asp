...
<td class="content_header_td" onMouseOver="return overlib('<#LANHostConfig_x_Gateway_itemdesc#>', LEFT);" onMouseOut="return nd();"><#LANHostConfig_x_Gateway_itemname#>
           </td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="lan_gateway" value="<% nvram_get_x("LANHostConfig","lan_gateway"); %>" onChange="page_changed()" onBlur="return validate_ipaddr(this, 'lan_gateway');" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
</table>
</td>
</tr>
