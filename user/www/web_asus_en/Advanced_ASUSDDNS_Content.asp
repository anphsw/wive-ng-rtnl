...
<td class="content_section_header_td" colspan="2"><#LANHostConfig_x_DDNSEnable_sectionname#></td>
</tr>
<tr>
	<td class="content_desc_td" colspan="2"><#LANHostConfig_x_DDNSEnable_sectiondesc#></td>
</tr>
<tr>
	<td class="content_header_td"><#LANHostConfig_x_DDNSEnable_itemname#></td>
	<td class="content_input_td">
		<input type="radio" value="1" name="ddns_enable_x" class="content_input_fd" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_enable_x', '1')" <% nvram_match_x("LANHostConfig","ddns_enable_x", "1", "checked"); %>>Yes</input>
		<input type="radio" value="0" name="ddns_enable_x" class="content_input_fd" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_enable_x', '0')" <% nvram_match_x("LANHostConfig","ddns_enable_x", "0", "checked"); %>>No</input>
	</td>
</tr>
<tr>
...
<!-- 2007.03.20 Yau add "WWW.ASUS.COM" -->
		...
		<div id="link">
        	<a href="javascript:openLink('x_DDNSServer')" class="content_input_link" name="x_DDNSServer_link"><#LANHostConfig_x_DDNSServer_linkname#></a>
		</div>
	</td>
</tr>
<tr>
	<td class="content_header_td" onMouseOver="return overlib('<#LANHostConfig_x_DDNSUserName_itemdesc#>', LEFT);" onMouseOut="return nd();"><#LANHostConfig_x_DDNSUserName_itemname#></td>
	<td class="content_input_td">
		<input type="text" maxlength="32" class="content_input_fd" size="32" name="ddns_username_x" value="<% nvram_get_x("LANHostConfig","ddns_username_x"); %>" onChange="page_changed()" onKeyPress="return is_string(this)" onBlur="validate_string(this)">
	</td>
</tr>
<tr>
	<td class="content_header_td" onMouseOver="return overlib('<#LANHostConfig_x_DDNSPassword_itemdesc#>', LEFT);" onMouseOut="return nd();"><#LANHostConfig_x_DDNSPassword_itemname#></td>
	<td class="content_input_td">
		<input type="password" maxlength="64" class="content_input_fd" size="32" name="ddns_passwd_x" value="<% nvram_get_x("LANHostConfig","ddns_passwd_x"); %>" onChange="page_changed()" onBlur="validate_string(this)">
	</td>
</tr>
<tr>
	<td class="content_header_td" onMouseOver="return overlib('<#LANHostConfig_x_DDNSHostNames_itemdesc#>', LEFT);" onMouseOut="return nd();"><#LANHostConfig_x_DDNSHostNames_itemname#><div id="Hostname_Note"><#LANHostConfig_x_DDNSHostNames_Note#></div></td>
	<td class="content_input_td">
		<input type="text" maxlength="63" class="content_input_fd" size="32" name="ddns_hostname_x" value="<% nvram_get_x("LANHostConfig","ddns_hostname_x"); %>" onChange="page_changed()" onKeyPress="return is_string(this)" onBlur="validate_string3(this)">
		<input type="submit" maxlength="15" class="inputSubmit" onClick="return onSubmitApply('hostname_check')" size="12" name="LANHostConfig_x_DDNSHostnameCheck_button" value="<#LANHostConfig_x_DDNSHostnameCheck_buttonname#>">
	</td>
</tr>
<tr>
	<td class="content_header_td" onMouseOver="return overlib('<#LANHostConfig_x_DDNSWildcard_itemdesc#>', LEFT);" onMouseOut="return nd();"><#LANHostConfig_x_DDNSWildcard_itemname#></td>
	<td class="content_input_td">
		<input type="radio" value="1" name="ddns_wildcard_x" class="content_input_fd" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_wildcard_x', '1')" <% nvram_match_x("LANHostConfig","ddns_wildcard_x", "1", "checked"); %>>Yes</input>
		<input type="radio" value="0" name="ddns_wildcard_x" class="content_input_fd" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_wildcard_x', '0')" <% nvram_match_x("LANHostConfig","ddns_wildcard_x", "0", "checked"); %>>No</input>
	</td>
</tr>
<tr>
	<td class="content_header_td" onMouseOver="return overlib('<#LANHostConfig_x_DDNSStatus_itemdesc#>', LEFT);" onMouseOut="return nd();"><#LANHostConfig_x_DDNSStatus_itemname#></td>
	<td class="content_input_td">
		<input type="hidden" maxlength="15" size="12" name="" value="<% nvram_get_f("ddns.log","DDNSStatus"); %>">
		<input type="submit" maxlength="15" class="inputSubmit" onClick="return onSubmitApply('ddnsclient')" size="12" name="LANHostConfig_x_DDNSStatus_button" value="<#LANHostConfig_x_DDNSStatus_buttonname#>">
	</td>
</tr>
</table>
</td>
