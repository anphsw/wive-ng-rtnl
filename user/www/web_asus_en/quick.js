...
//	else if (authType == "psk" && cryptoType == "tkip")
	else if (authType == "psk" && document.form.wl_wpa_mode.value == "1")
	{
...
function loadQuick()
{
	...
	if (document.form.wan_route_x.value == 'IP_Routed')
	{
		...
		else if (document.form.wan_proto.value == 'l2tp')	// oleg patch
		{
...
//	unmasq_wepkey();
	...
	else
	{
		...
		else if (document.form.x_WANType[5].checked == true)	// oleg patch
		{
		...
		else
		{
	   	...
	   	//if (document.form.wan_proto.value=="static" || document.form.wan_proto.value=="pptp")
                if (document.form.wan_proto.value=="static" ||	// oleg patch
                        document.form.wan_proto.value=="pptp" ||
                        document.form.wan_proto.value=="l2tp")
	   	{
   			...
   			if(	!validate_ipaddr_final(document.form.wan_ipaddr, 'wan_ipaddr') ||
                ...
                inputCtrl1(document.form.wan_ipaddr, 1);	// oleg patch
                inputCtrl1(document.form.wan_netmask, 1);	// oleg patch
                inputCtrl1(document.form.wan_gateway, 1); 	// oleg patch
...
function changeMode()
{
	if (document.form.x_Mode.value == 'Home Gateway' || document.form.x_Mode.value == 'Router')
	{
		...
		else
		{
			...
			if (document.form.x_WANType[1].checked == true || document.form.x_WANType[2].checked == true || document.form.x_WANType[4].checked == true || document.form.x_WANType[5].checked == true)	// oleg patch
			{
			...
			//else if(document.form.x_WANType[2].checked == true) 
			else if(document.form.x_WANType[2].checked == true || document.form.x_WANType[5].checked == true)	// oleg patch
			{
				//inputRCtrl1(document.form.x_DHCPClient, 0);
				...
				if (document.form.wan_ipaddr.value == "" || document.form.wan_ipaddr.value == "0.0.0.0")	// oleg patch
				{
        				inputRCtrl2(document.form.x_DHCPClient, 0);
				}
			}
...
function changeWANType()
{
	if (document.form.x_WANType[0].checked == true)
	{
		...
		//changeDHCPClient();	// oleg patch mark off
		//changeDNSServer();
	}
	else
	{
		...
		else if(document.form.x_WANType[2].checked == true || document.form.x_WANType[5].checked == true)	// oleg patch
		{
			...
			inputRCtrl2(document.form.wan_dnsenable_x, 0);	// oleg patch
			inputCtrl1(document.form.wan_dns1_x, 1);
			inputCtrl1(document.form.wan_dns2_x, 1);
			if (document.form.wan_ipaddr.value == "" || document.form.wan_ipaddr.value == "0.0.0.0")	// oleg patch
			{
	...
	changeDHCPClient();	// oleg patch
	changeDNSServer();
}

function changeDHCPClient_0314()
{
...
function changeFirewall(o, s)
{
	if (s == "WLANConfig11b")
	{
		...
		inputCtrl(document.form.wl_key_type,  flag);
	}
	else
	{
		return false;
...
function is_wlphrase_q(s, o)
{
	if (document.form.SecurityLevel.value=="1" || document.form.SecurityLevel.value=="2")
		return(is_wlphrase(s, 'wl_phrase_x', o));
	else
...
{
	if (document.form.SecurityLevel.value=="1" || document.form.SecurityLevel.value=="2")
		return(validate_wlphrase(s, 'wl_phrase_x', o));
	else
