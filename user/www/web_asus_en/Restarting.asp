  ...
  <tr bgcolor="#CCCCCC"> 
    <td width="666" height="125"> 
      <table width="660" height="125" cellpadding="2" cellspacing="0" border="0">
        ...
        <tr>
          <td width="652" height="25" bgcolor="#FFFFFF" colspan="2"><font face="Arial"><#SAVE_restart_desc#></td>
        </tr>
        <tr>
          <td width="652" height="25" bgcolor="#FFFFFF" colspan="2"><font face="Arial" color="#FF0000"><b><#SAVE_note#></b></font></td>
        </tr>
        </tbody>
      </table>
    </td>
