...
<tr>
<td></td><td class="content_list_input_td" colspan=""><input type="text" maxlength="12" class="content_input_list_fd" size="32" name="macfilter_list_x_0" onChange="page_changed()" onKeyPress="return is_hwaddr()"></td>
</tr>
<tr>
