...
<td class="content_header_td"><#Layer3Forwarding_x_ConnectionType_itemname#>
           </td><td class="content_input_td"><select name="wan_proto" class="content_input_fd" onChange="return change_common(this, 'Layer3Forwarding', 'wan_proto')"><option class="content_input_fd" value="dhcp" <% nvram_match_x("Layer3Forwarding","wan_proto", "dhcp","selected"); %>>Automatic IP</option><option class="content_input_fd" value="static" <% nvram_match_x("Layer3Forwarding","wan_proto", "static","selected"); %>>Static IP</option><option class="content_input_fd" value="pppoe" <% nvram_match_x("Layer3Forwarding","wan_proto", "pppoe","selected"); %>>PPPoE</option><option class="content_input_fd" value="pptp" <% nvram_match_x("Layer3Forwarding","wan_proto", "pptp","selected"); %>>PPTP</option><option class="content_input_fd" value="l2tp" <% nvram_match_x("Layer3Forwarding","wan_proto", "l2tp","selected"); %>>L2TP</option><option class="content_input_fd" value="bigpond" <% nvram_match_x("Layer3Forwarding","wan_proto", "bigpond","selected"); %>>BigPond</option><option class="content_input_fd" value="cdma" <% nvram_match_x("Layer3Forwarding","wan_proto", "cdma","selected"); %>>CDMA</option></select></td>
</tr>
<tr>
<td class="content_header_td"><#Layer3Forwarding_x_STB_itemname#>
           </td><td class="content_input_td"><select name="wan_stb_x" class="content_input_fd"><option class="content_input_fd" value="0" <% nvram_match_x("Layer3Forwarding","wan_stb_x", "0","selected"); %>>None</option><option class="content_input_fd" value="1" <% nvram_match_x("Layer3Forwarding","wan_stb_x", "1","selected"); %>>LAN1</option><option class="content_input_fd" value="2" <% nvram_match_x("Layer3Forwarding","wan_stb_x", "2","selected"); %>>LAN2</option><option class="content_input_fd" value="3" <% nvram_match_x("Layer3Forwarding","wan_stb_x", "3","selected"); %>>LAN3</option><option class="content_input_fd" value="4" <% nvram_match_x("Layer3Forwarding","wan_stb_x", "4","selected"); %>>LAN4</option><option class="content_input_fd" value="5" <% nvram_match_x("Layer3Forwarding","wan_stb_x", "5","selected"); %>>LAN3 & LAN4</option></select></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('<#PPPConnection_x_PPTPOptions_itemdesc#>', LEFT);" onMouseOut="return nd();"><#PPPConnection_x_PPTPOptions_itemname#>
...
<!--
<tr>
<td class="content_header_td" onMouseOver="return overlib('<#PPPConnection_x_AdditionalOptions_itemdesc#>', LEFT);" onMouseOut="return nd();"><#PPPConnection_x_AdditionalOptions_itemname#>
...
-->
<input type="hidden" name="wan_pppoe_options_x" value="<% nvram_get_x("PPPConnection","wan_pppoe_options_x"); %>">
<tr>
...
<td class="content_header_td" onMouseOver="return overlib('<#PPPConnection_x_HostNameForISP_itemdesc#>', LEFT);" onMouseOut="return nd();"><#PPPConnection_x_HostNameForISP_itemname#>
           </td><td class="content_input_td"><input type="text" maxlength="32" class="content_input_fd" size="32" name="wan_hostname" value="<% nvram_get_x("PPPConnection","wan_hostname"); %>" onKeyPress="return is_string(this)" onBlur="validate_string2(this)"></td>
</tr>
<tr>
...
<td class="content_header_td"><#PPPConnection_x_HeartBeat_itemname#>
           </td><td class="content_input_td"><input type="text" maxlength="256" class="content_input_fd" size="32" name="wan_heartbeat_x" value="<% nvram_get_x("PPPConnection","wan_heartbeat_x"); %>" onKeyPress="return is_string(this)" onBlur="validate_string3(this)"></td>
</tr>
</table>
</td>
</tr>
