...
PATH=/sbin:/bin:/usr/sbin:/usr/bin:/opt/Wive-RTNL/user/quagga/filesystem/sbin:/opt/Wive-RTNL/user/quagga/filesystem/bin
export PATH
...
command="/opt/Wive-RTNL/user/quagga/filesystem/sbin/${name}"
command_args="-d"
