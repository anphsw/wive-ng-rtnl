...
Currently available applets include:
	...
	blkid, brctl, bunzip2, bzcat, bzip2, cat, chattr, chmod, chown,
	chpasswd, clear, cp, crond, crontab, cut, date, dd, deluser, depmod,
	df, dhcprelay, dmesg, dnsdomainname, du, dumpleases, echo, egrep,
	env, ether-wake, expand, expr, false, fdisk, fgrep, find, flock,
	free, fsck, ftpd, ftpget, ftpput, fuser, grep, gunzip, gzip, halt,
	hd, head, hexdump, hostid, hostname, id, ifconfig, inetd, init,
	inotifyd, insmod, ionice, ip, ipaddr, ipcalc, iplink, iproute,
	iprule, iptunnel, kill, killall, killall5, klogd, linuxrc, ln,
	logger, login, lpd, lpq, lpr, ls, lsattr, lsmod, lsusb, md5sum,
	mdev, mkdir, mkdosfs, mke2fs, mkfs.ext2, mkfs.vfat, mknod, mkswap,
	modinfo, modprobe, more, mount, mv, netstat, nice, nslookup, ntpd,
	passwd, pgrep, pidof, ping, ping6, poweroff, printenv, printf, ps,
	pwd, rdate, reboot, renice, rev, rm, rmdir, rmmod, route, run-parts,
	sed, seq, sh, sleep, sort, split, stat, sum, swapoff, swapon,
	switch_root, sync, sysctl, syslogd, tail, tar, test, time, top,
	touch, traceroute, traceroute6, true, tune2fs, udhcpc, udhcpc6,
	udhcpd, umount, uname, uniq, uptime, usleep, vconfig, vi, watch,
	watchdog, wc, wget, which, whois, yes, zcat, zcip
