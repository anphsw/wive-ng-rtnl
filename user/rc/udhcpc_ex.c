...
apply(void)	// step 2 of 2-step dhcp lease application for RT-N13 repeater mode UI
{
	...
	eval("mii_mgr", "-s", "-p", "0", "-r", "0", "-v", "0x3900");	// link down switch port 0
	eval("mii_mgr", "-s", "-p", "1", "-r", "0", "-v", "0x3900");	// link down switch port 1
	eval("mii_mgr", "-s", "-p", "2", "-r", "0", "-v", "0x3900");	// link down switch port 2
	eval("mii_mgr", "-s", "-p", "3", "-r", "0", "-v", "0x3900");	// link down switch port 3
	eval("mii_mgr", "-s", "-p", "4", "-r", "0", "-v", "0x3900");	// link down switch port 4
	...
	eval("mii_mgr", "-s", "-p", "0", "-r", "0", "-v", "0x3100");	// link up switch port 0
	eval("mii_mgr", "-s", "-p", "1", "-r", "0", "-v", "0x3100");	// link up switch port 1
	eval("mii_mgr", "-s", "-p", "2", "-r", "0", "-v", "0x3100");	// link up switch port 2
	eval("mii_mgr", "-s", "-p", "3", "-r", "0", "-v", "0x3100");	// link up switch port 3
	eval("mii_mgr", "-s", "-p", "4", "-r", "0", "-v", "0x3100");	// link up switch port 4
