...
#ifndef lint
static const char rcsid[] = "$Id: chat.c,v 1.1.1.1 2008/07/21 09:20:35 james26_jang Exp $";
#endif
 ...
 */
	...
	while ((arg = ARG(argc, argv)) != NULL) {
	    chat_expect(arg);
	    syslog(LOG_INFO, "chat_expect=%s\n", arg);

	    if ((arg = ARG(argc, argv)) != NULL) {
		chat_send(arg);
		syslog(LOG_INFO, "chat_send=%s\n", arg);
		}
	}
    }
