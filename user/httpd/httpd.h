...
#if 0
static struct language_table language_tables[] = {	// EU_ZONE: EN/DE/RU/CZ
        {"ru-ru", "RU"},
        {"ru", "RU"},
        {"de-at", "DE"},
        {"de-li", "DE"},
...
#if 0
static struct language_table language_tables[] = {	// US_ZONE: EN/FR/TW/CN
        {"zh-tw", "TW"},
        {"zh", "TW"},   
        {"zh-hk", "CN"},
        {"zh-cn", "CN"},
...
static struct language_table language_tables[] = {      // TW_ZONE: EN/FR/TW/CN
        {"zh-tw", "TW"},
        {"zh", "TW"},
        {"en-us", "EN"},
        {"en", "EN"},
...
#if 0
static struct language_table language_tables[] = {	// PL_ZONE: EN/PL/FR (web)
        {"pl-pl", "PL"},
        {"pl", "PL"},
        {"fr", "FR"},
        {"fr-fr", "FR"},
...
#if 0
static struct language_table language_tables[] = {      // APAC_ZONE: EN/TW/MS/TH/TR
        {"zh-tw", "TW"},
        {"zh", "TW"},
        {"ms", "MS"},
        {"th", "TH"},
