...
<tr>
	...
	<td class="content_input_td">
		<input type="text" maxlength="4" size="4" name="qos_dfragment_size" class="content_input_fd" value="<% nvram_get_x("PrinterStatus", "qos_dfragment_size"); %>" onChange="page_changed()" onBlur="validate_range(this, 536, 1500)" onKeyPress="return is_number(this)">
	</td>
</tr>
...
<div align="center">
	    <table border="0" cellspacing="0" cellpadding="0">
			...
			<td></td>
		    	...
		    	<tr>
			<td></td>
			<td class="content_list_input_td" colspan=""><input type="text" maxlength="15" class="content_input_list_fd" size="14" name="qos_service_name_x_0" onChange="page_changed()" onKeyPress="return is_string(this)"></td>
			<td class="content_list_input_td" colspan=""><input type="text" maxlength="15" class="content_input_list_fd" size="14" name="qos_ip_x_0" onChange="page_changed()" onKeyPress="return is_iprange(this)" onKeyUp="change_iprange(this)"></td>
			<td class="content_list_input_td" colspan=""><input type="text" maxlength="10" size="10" class="content_input_list_fd" name="qos_port_x_0" onChange="page_changed()" onKeyPress="return is_portrange(this)"></td>
		        <td align="center">
