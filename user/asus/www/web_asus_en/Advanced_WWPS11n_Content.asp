...
function refresh_wpsinfo(xmldoc)
{
	...
	if (wpss==null || wpss[0]==null)
	{
		...
		{
			stopFlag=1;
			document.form.WPS_resetTimer.disabled=0;
		}
		return;
	}
	...
	if(nav)
	{
		...
		if (wps_infos[4].firstChild.nodeValue=="TKIPAES")
			document.getElementById("wps_crypto").innerHTML="TKIP+AES";
		else
	...
	else
	{
		...
		if (wps_infos[4].firstChild.nodeValue=="TKIPAES")
			document.getElementById("wps_crypto").innerText="TKIP+AES";
		else
...
<tr>
	...
	<td class="content_input_td">
		<input type="text" size="8" maxlength="8" class="content_input_fd" name="wps_pin" value="<% nvram_get_f("wps.log","wps_pin"); %>" onChange="page_changed()" onKeyPress="return is_number_sp(event, this);">
	</td>
</tr>

<tr>
	<td class="content_header_td_less">
		<input class="inputSubmit" type="submit" onClick="return resetTimer();" name="WPS_resetTimer" value="  <#CTL_refresh#>  ">&nbsp;
	</td>
	<td class="content_input_td">
