...
<table class="form">
  ...
  <tr> 
    ...
    <td>
      <input type="radio" name="bdenabled" value="1"><font id="bidirectEnable">Enable</font>
      <input type="radio" name="bdenabled" value="0"><font id="bidirectDisable">Disable</font>
    </td>
  </tr>
</table>
<table class="buttons">
  <tr>
    <td>
      <input type=submit class="normal" value="Apply" id="printerApply"> &nbsp; &nbsp;
      <input type=button class="normal" value="Cancel" id="printerCancel" onClick="window.location.reload()">
	<input type="hidden" name="submit-url" value="/usb/P910NDprintersrv.asp">
    </td>
  </tr>
</table>
</form>
