...
function open_diradd_window()
{
	...
	window.open("STORAGEaddsmbdir.asp","Samba_Dir_Add","toolbar=no, location=no, scrollbars=yes, resizable=no, width=640, height=640")
}
...
function open_diredit_window()
{
	if (CheckSelect())
	{
		...
		window.open("STORAGEeditsmbdir.asp","Samba_Dir_Edit","toolbar=no, location=no, scrollbars=yes, resizable=no, width=640, height=640")
	}
}
