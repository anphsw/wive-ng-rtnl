    ...
    <td><form method=post name="storage_adduser" action="/goform/StorageAddUser">
        ...
        <table width="90%" border="1" cellspacing="1" cellpadding="3" vspace="2" hspace="2" bordercolor="#9BABBD">
          <tr>
            ...
            <td><input type=radio name=adduser_ftp value="1" onClick="ftp_enable_switch()">
              <font id="adduserFtpEnable">Enable</font>&nbsp;
              <input type=radio name=adduser_ftp value="0" onClick="ftp_enable_switch()" checked>
              <font id="adduserFtpDisable">Disable</font></td>
          </tr>
          <tr>
        ...
        <table width="90%" border="1" cellspacing="1" cellpadding="3" vspace="2" hspace="2" bordercolor="#9BABBD">
          <tr>
            ...
            <td><input type=radio name=adduser_smb value="1">
              <font id="adduserSmbEnable">Enable</font>&nbsp;
              <input type=radio name=adduser_smb value="0" checked>
              <font id="adduserSmbDisable">Disable</font></td>
          </tr>
        </table>
        <hr />
        <br />
