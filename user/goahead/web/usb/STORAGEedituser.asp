      ...
      document.write(user);
        ...
        <table width="540" border="1" cellspacing="1" cellpadding="3" vspace="2" hspace="2" bordercolor="#9BABBD">
          <tr>
            ...
            <td><input type=radio name=edituser_ftp value="1" onClick="ftp_enable_switch()">
              <font id="edituserFtpEnable">Enable</font>&nbsp;
              <input type=radio name=edituser_ftp value="0" onClick="ftp_enable_switch()">
              <font id="edituserFtpDisable">Disable</font></td>
          </tr>
          <tr>
        ...
        <table width="540" border="1" cellspacing="1" cellpadding="3" vspace="2" hspace="2" bordercolor="#9BABBD">
          <tr>
            ...
            <td><input type=radio name=edituser_smb value="1">
              <font id="edituserSmbEnable">Enable</font>&nbsp;
              <input type=radio name=edituser_smb value="0">
              <font id="edituserSmbDisable">Disable</font></td>
          </tr>
        </table>
        <hr />
        <br />
