    ...
    <td><h1 id="storageAdmTitle">Administration</h1>
      ...
      <form method=post name=storage_user_adm action="/goform/storageAdm">
        ...
        <table width="90%" border="1" cellspacing="1" cellpadding="3" vspace="2" hspace="2" bordercolor="#9BABBD">
          <tr>
            <td class="title" colspan="4"><font id="storageAdmUser">User Management</font></td>
          </tr>
          <tr align=center>
...
for (var i=1;i<9;i++)
{
	if (eval("user"+i) != "")
	{
        ...
        <table width = "90%" border = "0" cellpadding = "2" cellspacing = "1">
          <tr align="center">
            <td><input type="button" style="{width:80px;}" name=storage_user_add value="Add" id="storageAdmUserAdd" onClick="open_useradd_window()">
              &nbsp;&nbsp;
        ...
        <table width = "90%" border = "0" cellpadding = "2" cellspacing = "1">
          <tr align="center">
            <td><input type="button" style="{width:80px;}" value="Apply" id="storageAdmApply" onClick="submit_apply('apply')">
              <input type="button" style="{width:80px;}" value="Cancle" id="storageCancel" onClick="window.location.reload()"></td>
          </tr>
        </table>
      </form></td>
  </tr>
