...
<table class="form">
  ...
  <tr> 
    ...
    <td>
	<select name="ftp_enabled" class="half" onchange="FtpEnableSwitch(this.form);" >
  ...
  <tr>
    ...
    <td>
      <input type=text name=ftp_port size=5 maxlength=5 value="<% getCfgGeneral(1, "FtpPort"); %>">
    </td>
  </tr>
  <tr>
	<td class="head" id="ftpSrvRootDir">FTP server root directory</td>
	<td>
      <input type=text name=ftp_rootdir size=50 maxlength=50 value="<% getCfgGeneral(1, "FtpRootDir"); %>">
    </td>
  </tr>
  <tr>
    <td class="head" id="ftpSrvLoginTimeout">FTP server idle timeout</td>
    <td>
      <input type=text name=ftp_idle_timeout size=4 maxlength=4 value="<% getCfgGeneral(1, "FtpIdleTime"); %>">
    </td>
  </tr>
</table>
<br />
<table class="buttons">
  <tr>
    <td>
	<input value="/usb/STORAGEftpsrv.asp" name="submit-url" type="hidden">
      <input type=submit class="normal" value="Apply" id="ftpApply"onclick="return CheckValue(this.form);" > &nbsp; &nbsp;
      <input type=reset  class="normal" value="Reset" id="ftpReset" onClick="window.location.reload()">
    </td>
  </tr>
</table>
</form>
