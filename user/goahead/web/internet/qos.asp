...
<tr id="QoSUpBW">
	...
	<td><input name="UpBW" class="short_qos" size="7" maxlength="7" type="text">&nbsp;&nbsp;KBits/sec</td>
</tr>
<tr id="QoSUpBWL">
	<td class="head" id="QoSUpBWLStr">Upload rate limit:</td>
	<td><input name="UpBWL" class="short_qos" size="7" maxlength="7" type="text">&nbsp;&nbsp;KBits/sec</td>
</tr>
<tr id="QoSDownBW">
	<td class="head" id="QoSDownBWStr">Download rate:</td>
	<td><input name="DownBW" class="short_qos" size="7" maxlength="7" type="text">&nbsp;&nbsp;KBits/sec</td>
</tr>
<tr id="QoSDownBWL">
	<td class="head" id="QoSDownBWLStr">Download rate limit:</td>
	<td><input name="DownBWL" class="short_qos" size="7" maxlength="7" type="text">&nbsp;&nbsp;KBits/sec</td>
</tr>
<tr id="QoSUPVPNBW">
	<td class="head" id="QoSUPVPNBWStr">Upload VPN rate:</td>
	<td><input name="UpVPNBW" class="short_qos" size="7" maxlength="7" type="text">&nbsp;&nbsp;KBits/sec</td>
</tr>
<tr id="QoSUPVPNBWL">
	<td class="head" id="QoSUPVPNBWLStr">Upload VPN rate limit:</td>
	<td><input name="UpVPNBWL" class="short_qos" size="7" maxlength="7" type="text">&nbsp;&nbsp;KBits/sec</td>
</tr>
<tr id="PPortSettings">
...
<tr>
	<td>
	<input value="/internet/qos.asp" name="submit-url" type="hidden">
      <input type=submit class="normal" value="Apply" id="QoSApply"> &nbsp; &nbsp;
      <input type=reset  class="normal" value="Reset" id="QoSReset" onClick="window.location.reload()">
	</td>
</tr>
</table>
</td></tr>
