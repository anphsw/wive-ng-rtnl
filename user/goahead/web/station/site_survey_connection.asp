...
function initValue()
{
	...
	//alert(document.sta_site_survey_connection.network_type.value);
	securityMode();
}
...
function check_Wep(securitymode)
{
	...
	if ( keyvalue.length == 0 && ( securitymode == 1 || document.sta_site_survey_connection.cert_auth_type_from_1x.value == 3)) // shared wep  || md5
	{
