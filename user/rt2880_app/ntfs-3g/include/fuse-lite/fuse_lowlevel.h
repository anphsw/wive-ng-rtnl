...
struct fuse_lowlevel_ops {
	 ...
	 */
	void (*setattr) (fuse_req_t req, fuse_ino_t ino, struct stat64 *attr,
 ...
 * @return zero for success, -errno for failure to send reply
 */
int fuse_reply_attr(fuse_req_t req, const struct stat64 *attr,
		    double attr_timeout);
...
size_t fuse_add_direntry(fuse_req_t req, char *buf, size_t bufsize,
			 const char *name, const struct stat64 *stbuf,
			 off_t off);
