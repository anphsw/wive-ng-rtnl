...
#define MTD_ROOTFS_PART_SIZE	IMAGE1_SIZE - (MTD_RWFS_PART_SIZE + MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE \
...
#else
#define MTD_KERN_PART_SIZE	IMAGE1_SIZE - (MTD_RWFS_PART_SIZE + MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE \
				+ MTD_FACTORY_PART_SIZE)
#endif
...
#define MTD_KERN2_PART_OFFSET	IMAGE1_SIZE + (MTD_RWFS_PART_SIZE + MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE \
					+ MTD_FACTORY_PART_SIZE)
