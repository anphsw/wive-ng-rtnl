cmd_drivers/net/wireless/rt2860v2_ap/../rt2860v2/common/crypt_biginteger.o := /opt/Wive-RTNL/toolchain/bin/mipsel-linux-uclibc-gcc -Wp,-MD,drivers/net/wireless/rt2860v2_ap/../rt2860v2/common/.crypt_biginteger.o.d  -nostdinc -isystem /opt/Wive-RTNL/toolchain/bin/../lib/gcc/mipsel-linux-uclibc/3.4.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Os -mips32 -mtune=mips32 -Os  -mabi=32 -G 0 -mno-abicalls -fno-pic -pipe -msoft-float -ffreestanding  -march=mips32 -Wa,-mips32 -Wa,--trap -Iinclude/asm-mips/rt2880 -ffreestanding -Iinclude/asm-mips/mach-generic -fomit-frame-pointer -gdwarf-2  -membedded-data -muninit-const-in-rodata -funit-at-a-time -funit-at-a-time -Wdeclaration-after-statement  -Idrivers/net/wireless/rt2860v2/include -DAGGREGATION_SUPPORT -DPIGGYBACK_SUPPORT -DWMM_SUPPORT  -DLINUX -Wall -Wstrict-prototypes -Wno-trigraphs -DCONFIG_AP_SUPPORT -DUAPSD_AP_SUPPORT -DRTMP_RBUS_SUPPORT -DRTMP_MAC_PCI -DDOT11_N_SUPPORT -DRELASE_EXCLUDE -DIAPP_SUPPORT  -DRALINK_ATE -DRALINK_28xx_QA -DCONFIG_RT2880_ATE_CMD_NEW -DMERGE_ARCH_TEAM -DSTATS_COUNT_SUPPORT -DRT3052 -DRT305x -DRTMP_RF_RW_SUPPORT -DQOS_DLS_SUPPORT -DIDS_SUPPORT -DCARRIER_DETECTION_SUPPORT -DTONE_RADAR_DETECT_SUPPORT -DDOT11N_DRAFT3 -DMCAST_RATE_SPECIFIC -DWMM_ACM_SUPPORT -DWLAN_LED -DWSC_AP_SUPPORT -DLLTD_SUPPORT -DWDS_SUPPORT -DMBSS_SUPPORT -DAPCLI_SUPPORT -DMAT_SUPPORT -DMLME_EX -DIGMP_SNOOP_SUPPORT -DCOC_SUPPORT -DMEMORY_OPTIMIZATION -DNEW_RATE_ADAPT_SUPPORT  -DMODULE -mlong-calls -Os -mips32 -mtune=mips32 -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(crypt_biginteger)"  -D"KBUILD_MODNAME=KBUILD_STR(rt2860v2_ap)" -c -o drivers/net/wireless/rt2860v2_ap/../rt2860v2/common/crypt_biginteger.o drivers/net/wireless/rt2860v2_ap/../rt2860v2/common/crypt_biginteger.c
...
deps_drivers/net/wireless/rt2860v2_ap/../rt2860v2/common/crypt_biginteger.o := \
  ...
  /opt/Wive-RTNL/toolchain/bin/../lib/gcc/mipsel-linux-uclibc/3.4.2/include/stdarg.h \
  ...
  drivers/net/wireless/rt2860v2/include/rtmp_def.h \
    ...
    $(wildcard include/config/16mbssid/mode.h) \
  ...
  drivers/net/wireless/rt2860v2/include/chip/rt305x.h \
  ...
  drivers/net/wireless/rt2860v2/include/led_def.h \
  ...
  drivers/net/wireless/rt2860v2/include/dfs.h \
  ...
  drivers/net/wireless/rt2860v2/include/ap_uapsd.h \
  ...
  drivers/net/wireless/rt2860v2/include/acm_extr.h \
    $(wildcard include/config/sta/support/sim.h) \
  drivers/net/wireless/rt2860v2/include/igmp_snoop.h \
  drivers/net/wireless/rt2860v2/include/rt_ate.h \
  drivers/net/wireless/rt2860v2/include/crypt_biginteger.h \
