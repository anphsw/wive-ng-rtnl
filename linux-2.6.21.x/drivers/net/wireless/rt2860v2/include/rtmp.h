...
//    ULONG           					TimBitmap2;     // b0 for AID32, b1 for AID33, ... and so on
	...
	UCHAR								NMK[16];
	UCHAR								key_announce_flag[LEN_TX_IV];	
...
ULONG RTMPInsertWpiIvHdr(
	IN 	PRTMP_ADAPTER 	pAd,
	IN	UCHAR			key_id,
	IN	UCHAR			*tx_iv, 
	IN 	PUCHAR 			pFrameBuf);

VOID wpi_construct_iv_hdr(
	IN 	PRTMP_ADAPTER 	pAd,
	IN	UCHAR			key_id,
	IN	UCHAR			*tx_iv,
	OUT UCHAR 			*iv_hdr);
