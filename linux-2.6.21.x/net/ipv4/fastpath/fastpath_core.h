...
enum LR_RESULT fastpath_addNaptConnection(struct ip_conntrack_tuple ori_tuple,
		struct ip_conntrack_tuple reply_tuple, enum NP_FLAGS flags);

enum LR_RESULT fastpath_delNaptConnection (struct ip_conntrack_tuple ori_tuple,
...
extern int ip_finish_output3(struct sk_buff *skb);
