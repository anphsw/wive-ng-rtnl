...
# CONFIG_OOM_EMBEDDED_REBOOT is not set
...
CONFIG_ARP_NOTIFY_MEDIA_STATE=y
CONFIG_ARP_HASH_FASTPATH=y
...
CONFIG_NF_PRIVILEGE_CONNTRACK=y
# CONFIG_NF_PRIVILEGE_CONNTRACK_DEBUG is not set
CONFIG_NF_FLUSH_CONNTRACK=y
...
CONFIG_BRIDGE_IGMP_REPORT_NO_FLOODING=y
CONFIG_BRIDGE_FORWARD_CTRL=y
CONFIG_BRIDGE_MAC_AUTO=y
CONFIG_BRIDGE_PORT_FORWARD=y
CONFIG_BRIDGE_IGMPP_PROCFS=y
# CONFIG_BRIDGE_IGMPP_PROCFS_DEBUG is not set
CONFIG_BRIDGE_FASTPATH=y
CONFIG_BRIDGE_EAP=y
CONFIG_VLAN_8021Q=y
...
CONFIG_NET_PPPOE_IPV6_PTHROUGH=y
...
CONFIG_PPP=m
CONFIG_PPP_PREVENT_DROP_SESSION_ON_FULL_CPU_LOAD=y
...
CONFIG_PPP_MPPE=m
CONFIG_PPPOE=m
CONFIG_PPPOE_FASTPATH=y
CONFIG_PPPOL2TP=m
# CONFIG_PPPOL2TP_FASTPATH is not set
CONFIG_PPTP=m
...
#
# Ethernet Ralink RT3xx/RT28xx wire driver.
#
CONFIG_RAETH=y
CONFIG_RAETH_NAPI=y
...
CONFIG_RAETH_SNMPD=y
CONFIG_RAETH_DHCP_TOUCH=y
# CONFIG_RAETH_READ_MAC_FROM_MTD is not set
# CONFIG_RAETH_MEMORY_OPTIMIZATION is not set
CONFIG_RAETH_ACCEPT_OVERSIZED=y

#
# Platform config for  Ralink RT3xx/RT28xx/RT5xx.
#
...
#
# Ralink RT3xx/RT28xx NAT Acell support.
#
CONFIG_RA_HW_NAT=m
...
# CONFIG_RA_HW_NAT_MINIMAL is not set

#
# AP MODE Ralink RT3xx/RT28xx wireless driver.
#
CONFIG_RT2860V2_AP=m
# CONFIG_RT2860V2_AP_V24_DATA_STRUCTURE is not set
CONFIG_RT2860V2_AP_LED=y
CONFIG_RT2860V2_AP_WSC=y
CONFIG_RT2860V2_AP_WIN7PREVIEW=y
...
# CONFIG_RALINK_RT2880_AP_DBG is not set
# CONFIG_RT2860V2_SET_MAC_FROM_EEPROM is not set
CONFIG_RT2860V2_AP_BRIDGE_FASTPATH=y

#
# STA/Client MODE Ralink RT3xx/RT28xx wireless driver.
#
...
# CONFIG_RALINK_RT2880_STA_DBG is not set

#
# 802.11a wireless driver.
#
