...
# CONFIG_USER_GOAHEAD_HAS_WPSBTN is not set
...
# CONFIG_USER_PPPPOE_RELAY is not set
CONFIG_USER_PARPROUTED=y
...
# CONFIG_USER_CHILLISPOT is not set
...
#
CONFIG_RT2880_APP=y
# CONFIG_RT2860V2_USER_MEMORY_OPTIMIZATION is not set
# CONFIG_RT2880_ATED is not set
...
CONFIG_LIB_LIBNVRAM_FORCE=y
CONFIG_RT2880_RAINIT=y
# CONFIG_RT2880_RADAEMON is not set
CONFIG_RT2880_L2_MANAGE=y
CONFIG_RT2880_MTD=y
# CONFIG_RT2880_MTD_VERF is not set
...
# 3G support
#
# CONFIG_USB_MODESWITCH is not set
