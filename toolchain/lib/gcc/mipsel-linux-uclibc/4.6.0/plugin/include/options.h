...
enum opt_code
{
  ...
  OPT_Wraw = 299,                            /* -Wraw */
  OPT_Wredundant_decls = 300,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 301,            /* -Wredundant-modifiers */
  OPT_Wreorder = 302,                        /* -Wreorder */
  OPT_Wreturn_type = 303,                    /* -Wreturn-type */
  OPT_Wselector = 304,                       /* -Wselector */
  OPT_Wsequence_point = 305,                 /* -Wsequence-point */
  OPT_Wserial = 306,                         /* -Wserial */
  OPT_Wshadow = 307,                         /* -Wshadow */
  OPT_Wsign_compare = 308,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 309,                /* -Wsign-conversion */
  OPT_Wsign_promo = 310,                     /* -Wsign-promo */
  OPT_Wspecial_param_hiding = 311,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 312,                /* -Wstack-protector */
  OPT_Wstatic_access = 313,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 314,                /* -Wstatic-receiver */
  ...
  OPT_Wsuggest_attribute_noreturn = 323,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 324,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 325,                       /* -Wsuppress */
  OPT_Wsurprising = 326,                     /* -Wsurprising */
  OPT_Wswitch = 327,                         /* -Wswitch */
  OPT_Wswitch_default = 328,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 329,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 330,                      /* -Wsync-nand */
  OPT_Wsynth = 331,                          /* -Wsynth */
  OPT_Wsynthetic_access = 332,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 333,                 /* -Wsystem-headers */
  OPT_Wtabs = 334,                           /* -Wtabs */
  OPT_Wtasks = 335,                          /* -Wtasks */
  OPT_Wtraditional = 336,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 337,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 338,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 339,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 340,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 341,                    /* -Wtype-limits */
  OPT_Wuncheck = 342,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 343,            /* -Wundeclared-selector */
  OPT_Wundef = 344,                          /* -Wundef */
  OPT_Wunderflow = 345,                      /* -Wunderflow */
  OPT_Wuninitialized = 346,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 347,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 348,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 349,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 350, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 351,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 352,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 353,                         /* -Wunused */
  OPT_Wunused_argument = 354,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 355,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 356,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 357,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 358,                /* -Wunused-function */
  OPT_Wunused_import = 359,                  /* -Wunused-import */
  OPT_Wunused_label = 360,                   /* -Wunused-label */
  OPT_Wunused_local = 361,                   /* -Wunused-local */
  OPT_Wunused_macros = 362,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 363,               /* -Wunused-parameter */
  OPT_Wunused_private = 364,                 /* -Wunused-private */
  OPT_Wunused_result = 365,                  /* -Wunused-result */
  OPT_Wunused_thrown = 366,                  /* -Wunused-thrown */
  OPT_Wunused_value = 367,                   /* -Wunused-value */
  OPT_Wunused_variable = 368,                /* -Wunused-variable */
  OPT_Wuseless_type_check = 369,             /* -Wuseless-type-check */
  OPT_Wvarargs_cast = 370,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 371,                /* -Wvariadic-macros */
  OPT_Wvla = 372,                            /* -Wvla */
  OPT_Wvolatile_register_var = 373,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 374,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 375,                  /* -Wwrite-strings */
  ...
  /* OPT_bootclasspath = 385, */             /* -bootclasspath */
  OPT_c = 386,                               /* -c */
  /* OPT_classpath = 387, */                 /* -classpath */
  OPT_coverage = 388,                        /* -coverage */
  OPT_cpp = 389,                             /* -cpp */
  OPT_cpp_ = 390,                            /* -cpp= */
  OPT_d = 391,                               /* -d */
  OPT_dumpbase = 392,                        /* -dumpbase */
  OPT_dumpdir = 393,                         /* -dumpdir */
  OPT_dumpmachine = 394,                     /* -dumpmachine */
  OPT_dumpspecs = 395,                       /* -dumpspecs */
  OPT_dumpversion = 396,                     /* -dumpversion */
  OPT_e = 397,                               /* -e */
  /* OPT_encoding = 398, */                  /* -encoding */
  OPT_export_dynamic = 399,                  /* -export-dynamic */
  OPT_extdirs = 400,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 401, */               /* -fCLASSPATH= */
  OPT_fPIC = 402,                            /* -fPIC */
  OPT_fPIE = 403,                            /* -fPIE */
  OPT_fRTS_ = 404,                           /* -fRTS= */
  OPT_fabi_version_ = 405,                   /* -fabi-version= */
  OPT_faccess_control = 406,                 /* -faccess-control */
  OPT_falign_commons = 407,                  /* -falign-commons */
  OPT_falign_functions = 408,                /* -falign-functions */
  OPT_falign_functions_ = 409,               /* -falign-functions= */
  OPT_falign_jumps = 410,                    /* -falign-jumps */
  OPT_falign_jumps_ = 411,                   /* -falign-jumps= */
  OPT_falign_labels = 412,                   /* -falign-labels */
  OPT_falign_labels_ = 413,                  /* -falign-labels= */
  OPT_falign_loops = 414,                    /* -falign-loops */
  OPT_falign_loops_ = 415,                   /* -falign-loops= */
  OPT_fall_intrinsics = 416,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 417, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 418,       /* -fallow-leading-underscore */
  /* OPT_falt_external_templates = 419, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 420, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 421, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 422, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 423, */  /* -fargument-noalias-global */
  OPT_fasm = 424,                            /* -fasm */
  OPT_fassert = 425,                         /* -fassert */
  OPT_fassociative_math = 426,               /* -fassociative-math */
  OPT_fassume_compiled = 427,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 428,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 429,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 430,                   /* -fauto-inc-dec */
  OPT_fautomatic = 431,                      /* -fautomatic */
  OPT_faux_classpath = 432,                  /* -faux-classpath */
  OPT_fbackslash = 433,                      /* -fbackslash */
  OPT_fbacktrace = 434,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 435,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 436,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 437,              /* -fbootstrap-classes */
  OPT_fbounds_check = 438,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 439,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 440,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 441,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 442,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 443,               /* -fbtr-bb-exclusive */
  OPT_fbuiltin = 444,                        /* -fbuiltin */
  OPT_fbuiltin_ = 445,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 446,                    /* -fcall-saved- */
  OPT_fcall_used_ = 447,                     /* -fcall-used- */
  OPT_fcaller_saves = 448,                   /* -fcaller-saves */
  OPT_fcheck_array_temporaries = 449,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 450,                /* -fcheck-data-deps */
  OPT_fcheck_new = 451,                      /* -fcheck-new */
  OPT_fcheck_references = 452,               /* -fcheck-references */
  OPT_fcheck_ = 453,                         /* -fcheck= */
  OPT_fclasspath_ = 454,                     /* -fclasspath= */
  OPT_fcoarray_ = 455,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 456,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 457,                         /* -fcommon */
  OPT_fcompare_debug = 458,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 459,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 460,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 461,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 462,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 463,                  /* -fcond-mismatch */
  OPT_fconserve_space = 464,                 /* -fconserve-space */
  OPT_fconserve_stack = 465,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 466,         /* -fconstant-string-class= */
  OPT_fconvert_big_endian = 467,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 468,          /* -fconvert=little-endian */
  OPT_fconvert_native = 469,                 /* -fconvert=native */
  OPT_fconvert_swap = 470,                   /* -fconvert=swap */
  OPT_fcprop_registers = 471,                /* -fcprop-registers */
  OPT_fcray_pointer = 472,                   /* -fcray-pointer */
  ...
  OPT_fd_lines_as_code = 478,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 479,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 480,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 481,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 482,                       /* -fdbg-cnt= */
  OPT_fdce = 483,                            /* -fdce */
  OPT_fdebug_prefix_map_ = 484,              /* -fdebug-prefix-map= */
  OPT_fdeduce_init_list = 485,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 486,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 487, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 488,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 489,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 490,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 491,                 /* -fdelayed-branch */
  OPT_fdelete_null_pointer_checks = 492,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 493,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_location_ = 494,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 495,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 496,                /* -fdirectives-only */
  OPT_fdisable_assertions = 497,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 498,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 499,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 500,         /* -fdollars-in-identifiers */
  OPT_fdse = 501,                            /* -fdse */
  OPT_fdump_ = 502,                          /* -fdump- */
  OPT_fdump_core = 503,                      /* -fdump-core */
  OPT_fdump_final_insns = 504,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 505,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 506,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 507,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 508,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 509,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 510,                /* -fdump-parse-tree */
  OPT_fdump_unnumbered = 511,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 512,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 513,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 514,                 /* -fearly-inlining */
  OPT_felide_constructors = 515,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 516,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 517, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 518,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 519,        /* -femit-class-debug-always */
  OPT_femit_class_file = 520,                /* -femit-class-file */
  OPT_femit_class_files = 521,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 522,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 523,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 524,      /* -femit-struct-debug-reduced */
  OPT_fenable_assertions = 525,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 526,             /* -fenable-assertions= */
  OPT_fenable_icf_debug = 527,               /* -fenable-icf-debug */
  OPT_fencoding_ = 528,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 529,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 530, */           /* -fenum-int-equiv */
  OPT_fexceptions = 531,                     /* -fexceptions */
  OPT_fexcess_precision_ = 532,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 533,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 534,        /* -fexpensive-optimizations */
  OPT_fextdirs_ = 535,                       /* -fextdirs= */
  OPT_fextended_identifiers = 536,           /* -fextended-identifiers */
  OPT_fexternal_blas = 537,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 538, */       /* -fexternal-templates */
  OPT_ff2c = 539,                            /* -ff2c */
  OPT_ffast_math = 540,                      /* -ffast-math */
  OPT_ffilelist_file = 541,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 542,               /* -ffinite-math-only */
  OPT_ffixed_ = 543,                         /* -ffixed- */
  OPT_ffixed_form = 544,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 545,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 546,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 547,                    /* -ffloat-store */
  OPT_ffor_scope = 548,                      /* -ffor-scope */
  /* OPT_fforce_addr = 549, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 550,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 551,              /* -fforward-propagate */
  OPT_ffp_contract_ = 552,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 553,                      /* -ffpe-trap= */
  OPT_ffree_form = 554,                      /* -ffree-form */
  OPT_ffree_line_length_ = 555,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 556,          /* -ffree-line-length-none */
  OPT_ffreestanding = 557,                   /* -ffreestanding */
  OPT_ffriend_injection = 558,               /* -ffriend-injection */
  OPT_ffunction_cse = 559,                   /* -ffunction-cse */
  OPT_ffunction_sections = 560,              /* -ffunction-sections */
  OPT_fgcse = 561,                           /* -fgcse */
  OPT_fgcse_after_reload = 562,              /* -fgcse-after-reload */
  OPT_fgcse_las = 563,                       /* -fgcse-las */
  OPT_fgcse_lm = 564,                        /* -fgcse-lm */
  OPT_fgcse_sm = 565,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 566,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 567,                    /* -fgnu-runtime */
  OPT_fgnu89_inline = 568,                   /* -fgnu89-inline */
  OPT_fgo_dump_ = 569,                       /* -fgo-dump- */
  OPT_fgo_prefix_ = 570,                     /* -fgo-prefix= */
  OPT_fgraphite = 571,                       /* -fgraphite */
  OPT_fgraphite_identity = 572,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 573,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 574, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 575, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 576,           /* -fhash-synchronization */
  /* OPT_fhelp = 577, */                     /* -fhelp */
  /* OPT_fhelp_ = 578, */                    /* -fhelp= */
  /* OPT_fhonor_std = 579, */                /* -fhonor-std */
  OPT_fhosted = 580,                         /* -fhosted */
  /* OPT_fhuge_objects = 581, */             /* -fhuge-objects */
  OPT_fident = 582,                          /* -fident */
  OPT_fif_conversion = 583,                  /* -fif-conversion */
  OPT_fif_conversion2 = 584,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 585,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 586,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 587,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 588,             /* -fimplicit-templates */
  OPT_findirect_classes = 589,               /* -findirect-classes */
  OPT_findirect_dispatch = 590,              /* -findirect-dispatch */
  OPT_findirect_inlining = 591,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 592,         /* -finhibit-size-directive */
  OPT_finit_character_ = 593,                /* -finit-character= */
  OPT_finit_integer_ = 594,                  /* -finit-integer= */
  OPT_finit_local_zero = 595,                /* -finit-local-zero */
  OPT_finit_logical_ = 596,                  /* -finit-logical= */
  OPT_finit_real_ = 597,                     /* -finit-real= */
  OPT_finline = 598,                         /* -finline */
  OPT_finline_functions = 599,               /* -finline-functions */
  OPT_finline_functions_called_once = 600,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 601, */            /* -finline-limit- */
  OPT_finline_limit_ = 602,                  /* -finline-limit= */
  OPT_finline_small_functions = 603,         /* -finline-small-functions */
  OPT_finput_charset_ = 604,                 /* -finput-charset= */
  OPT_finstrument_functions = 605,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 606,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 607,/* -finstrument-functions-exclude-function-list= */
  OPT_fintrinsic_modules_path = 608,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 609,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 610,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 611,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 612,                    /* -fipa-profile */
  OPT_fipa_pta = 613,                        /* -fipa-pta */
  OPT_fipa_pure_const = 614,                 /* -fipa-pure-const */
  OPT_fipa_reference = 615,                  /* -fipa-reference */
  OPT_fipa_sra = 616,                        /* -fipa-sra */
  OPT_fipa_struct_reorg = 617,               /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 618,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 619,              /* -fira-loop-pressure */
  OPT_fira_region_ = 620,                    /* -fira-region= */
  OPT_fira_share_save_slots = 621,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 622,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 623,                   /* -fira-verbose= */
  OPT_fivopts = 624,                         /* -fivopts */
  OPT_fjni = 625,                            /* -fjni */
  OPT_fjump_tables = 626,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 627,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 628,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 629,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 630, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 631,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 632,             /* -fleading-underscore */
  OPT_floop_block = 633,                     /* -floop-block */
  OPT_floop_flatten = 634,                   /* -floop-flatten */
  OPT_floop_interchange = 635,               /* -floop-interchange */
  /* OPT_floop_optimize = 636, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 637,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 638,                /* -floop-strip-mine */
  OPT_flto = 639,                            /* -flto */
  OPT_flto_compression_level_ = 640,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 641,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 642,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 643,             /* -flto-partition=none */
  OPT_flto_report = 644,                     /* -flto-report */
  OPT_flto_ = 645,                           /* -flto= */
  OPT_fltrans = 646,                         /* -fltrans */
  OPT_fltrans_output_list_ = 647,            /* -fltrans-output-list= */
  OPT_fmain_ = 648,                          /* -fmain= */
  OPT_fmath_errno = 649,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 650,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 651,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 652,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 653,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 654,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 655,                     /* -fmem-report */
  OPT_fmerge_all_constants = 656,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 657,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 658,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 659,                /* -fmessage-length= */
  OPT_fmodule_private = 660,                 /* -fmodule-private */
  OPT_fmodulo_sched = 661,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 662,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 663,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 664,                  /* -fms-extensions */
  OPT_fmudflap = 665,                        /* -fmudflap */
  OPT_fmudflapir = 666,                      /* -fmudflapir */
  OPT_fmudflapth = 667,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 668, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 669, */                  /* -fnew-abi */
  OPT_fnext_runtime = 670,                   /* -fnext-runtime */
  OPT_fnil_receivers = 671,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 672,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 673,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 674, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 675,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 676,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 677,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 678,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 679,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 680,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 681,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 682,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 683,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 684,             /* -fomit-frame-pointer */
  OPT_fopenmp = 685,                         /* -fopenmp */
  OPT_foperator_names = 686,                 /* -foperator-names */
  OPT_foptimize_register_move = 687,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 688,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 689,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 690, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 691,              /* -foutput-class-dir= */
  OPT_fpack_derived = 692,                   /* -fpack-derived */
  OPT_fpack_struct = 693,                    /* -fpack-struct */
  OPT_fpack_struct_ = 694,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 695,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 696,              /* -fpcc-struct-return */
  OPT_fpch_deps = 697,                       /* -fpch-deps */
  OPT_fpch_preprocess = 698,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 699,                     /* -fpeel-loops */
  OPT_fpeephole = 700,                       /* -fpeephole */
  OPT_fpeephole2 = 701,                      /* -fpeephole2 */
  OPT_fpermissive = 702,                     /* -fpermissive */
  OPT_fpic = 703,                            /* -fpic */
  OPT_fpie = 704,                            /* -fpie */
  OPT_fplan9_extensions = 705,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 706,                    /* -fplugin-arg- */
  OPT_fplugin_ = 707,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 708,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 709,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 710,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 711,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 712,                   /* -fpreprocessed */
  OPT_fpretty_templates = 713,               /* -fpretty-templates */
  OPT_fprofile = 714,                        /* -fprofile */
  OPT_fprofile_arcs = 715,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 716,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 717,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 718,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 719,              /* -fprofile-generate= */
  OPT_fprofile_use = 720,                    /* -fprofile-use */
  OPT_fprofile_use_ = 721,                   /* -fprofile-use= */
  OPT_fprofile_values = 722,                 /* -fprofile-values */
  OPT_fprotect_parens = 723,                 /* -fprotect-parens */
  OPT_frandom_seed = 724,                    /* -frandom-seed */
  OPT_frandom_seed_ = 725,                   /* -frandom-seed= */
  OPT_frange_check = 726,                    /* -frange-check */
  OPT_frealloc_lhs = 727,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 728,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 729,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 730,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 731,                /* -frecord-marker=8 */
  OPT_frecursive = 732,                      /* -frecursive */
  OPT_freduced_reflection = 733,             /* -freduced-reflection */
  OPT_freg_struct_return = 734,              /* -freg-struct-return */
  OPT_fregmove = 735,                        /* -fregmove */
  OPT_frename_registers = 736,               /* -frename-registers */
  OPT_freorder_blocks = 737,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 738,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 739,              /* -freorder-functions */
  OPT_frepack_arrays = 740,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 741,           /* -freplace-objc-classes */
  OPT_frepo = 742,                           /* -frepo */
  OPT_frequire_return_statement = 743,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 744,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 745, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 746,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 747,                    /* -fresolution= */
  OPT_frounding_math = 748,                  /* -frounding-math */
  OPT_frtti = 749,                           /* -frtti */
  OPT_fsaw_java_file = 750,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 751,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 752,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 753,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 754,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 755,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 756,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 757,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 758,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 759,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 760,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 761,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 762,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 763,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 764,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 765,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 766,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 767,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 768, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 769,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 770,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 771,              /* -fsecond-underscore */
  OPT_fsection_anchors = 772,                /* -fsection-anchors */
  /* OPT_fsee = 773, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 774,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 775,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 776, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 777,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 778,          /* -fselective-scheduling2 */
  OPT_fshort_double = 779,                   /* -fshort-double */
  OPT_fshort_enums = 780,                    /* -fshort-enums */
  OPT_fshort_wchar = 781,                    /* -fshort-wchar */
  OPT_fshow_column = 782,                    /* -fshow-column */
  OPT_fsign_zero = 783,                      /* -fsign-zero */
  OPT_fsignaling_nans = 784,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 785,               /* -fsigned-bitfields */
  OPT_fsigned_char = 786,                    /* -fsigned-char */
  OPT_fsigned_zeros = 787,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 788,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 789,               /* -fsource-filename= */
  OPT_fsource_ = 790,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 791,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 792,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 793,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 794, */                 /* -fsquangle */
  /* OPT_fstack_check = 795, */              /* -fstack-check */
  OPT_fstack_check_ = 796,                   /* -fstack-check= */
  OPT_fstack_limit = 797,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 798,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 799,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 800,                /* -fstack-protector */
  OPT_fstack_protector_all = 801,            /* -fstack-protector-all */
  OPT_fstack_usage = 802,                    /* -fstack-usage */
  OPT_fstats = 803,                          /* -fstats */
  OPT_fstore_check = 804,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 805, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 806,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 807,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 808,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 809, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 810,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 811,                    /* -fsyntax-only */
  OPT_ftabstop_ = 812,                       /* -ftabstop= */
  /* OPT_ftarget_help = 813, */              /* -ftarget-help */
  OPT_ftarget_ = 814,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 815, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 816,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 817,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 818, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 819,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 820,             /* -fthreadsafe-statics */
  OPT_ftime_report = 821,                    /* -ftime-report */
  OPT_ftls_model_ = 822,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 823,               /* -ftoplevel-reorder */
  OPT_ftracer = 824,                         /* -ftracer */
  OPT_ftrapping_math = 825,                  /* -ftrapping-math */
  OPT_ftrapv = 826,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 827,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 828,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 829,                       /* -ftree-ccp */
  OPT_ftree_ch = 830,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 831,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 832,                /* -ftree-copyrename */
  OPT_ftree_cselim = 833,                    /* -ftree-cselim */
  OPT_ftree_dce = 834,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 835,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 836,                       /* -ftree-dse */
  OPT_ftree_forwprop = 837,                  /* -ftree-forwprop */
  OPT_ftree_fre = 838,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 839,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 840,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 841,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 842,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 843,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 844,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 845, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 846,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 847,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 848,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 849,                   /* -ftree-phiprop */
  OPT_ftree_pre = 850,                       /* -ftree-pre */
  OPT_ftree_pta = 851,                       /* -ftree-pta */
  OPT_ftree_reassoc = 852,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 853, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 854,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 855,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 856,             /* -ftree-slp-vectorize */
  ...
  OPT_ftree_ter = 861,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 862,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 863,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 864,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 865,                       /* -ftree-vrp */
  OPT_funderscoring = 866,                   /* -funderscoring */
  OPT_funit_at_a_time = 867,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 868,               /* -funroll-all-loops */
  OPT_funroll_loops = 869,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 870,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 871,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 872,             /* -funsigned-bitfields */
  OPT_funsigned_char = 873,                  /* -funsigned-char */
  OPT_funswitch_loops = 874,                 /* -funswitch-loops */
  OPT_funwind_tables = 875,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 876,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 877,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 878,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 879,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 880,          /* -fuse-divide-subroutine */
  ...
  OPT_fverbose_asm = 888,                    /* -fverbose-asm */
  /* OPT_fversion = 889, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 890,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 891,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 892,                    /* -fvisibility= */
  OPT_fvpt = 893,                            /* -fvpt */
  /* OPT_fvtable_gc = 894, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 895, */            /* -fvtable-thunks */
  OPT_fweak = 896,                           /* -fweak */
  OPT_fweb = 897,                            /* -fweb */
  OPT_fwhole_file = 898,                     /* -fwhole-file */
  OPT_fwhole_program = 899,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 900,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 901,              /* -fworking-directory */
  OPT_fwpa = 902,                            /* -fwpa */
  OPT_fwrapv = 903,                          /* -fwrapv */
  /* OPT_fxref = 904, */                     /* -fxref */
  OPT_fzee = 905,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 906,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 907,                      /* -fzero-link */
  OPT_g = 908,                               /* -g */
  OPT_gant = 909,                            /* -gant */
  OPT_gcoff = 910,                           /* -gcoff */
  OPT_gdwarf_ = 911,                         /* -gdwarf- */
  OPT_gen_decls = 912,                       /* -gen-decls */
  OPT_ggdb = 913,                            /* -ggdb */
  OPT_gnat = 914,                            /* -gnat */
  OPT_gnatO = 915,                           /* -gnatO */
  OPT_gno_strict_dwarf = 916,                /* -gno-strict-dwarf */
  OPT_gstabs = 917,                          /* -gstabs */
  OPT_gstabs_ = 918,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 919,                   /* -gstrict-dwarf */
  OPT_gtoggle = 920,                         /* -gtoggle */
  OPT_gvms = 921,                            /* -gvms */
  OPT_gxcoff = 922,                          /* -gxcoff */
  OPT_gxcoff_ = 923,                         /* -gxcoff+ */
  OPT_h = 924,                               /* -h */
  OPT_idirafter = 925,                       /* -idirafter */
  OPT_imacros = 926,                         /* -imacros */
  OPT_imultilib = 927,                       /* -imultilib */
  OPT_include = 928,                         /* -include */
  OPT_iplugindir_ = 929,                     /* -iplugindir= */
  OPT_iprefix = 930,                         /* -iprefix */
  OPT_iquote = 931,                          /* -iquote */
  OPT_isysroot = 932,                        /* -isysroot */
  OPT_isystem = 933,                         /* -isystem */
  OPT_iwithprefix = 934,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 935,               /* -iwithprefixbefore */
  OPT_k8 = 936,                              /* -k8 */
  OPT_l = 937,                               /* -l */
  OPT_lang_asm = 938,                        /* -lang-asm */
  OPT_mabi_ = 939,                           /* -mabi= */
  OPT_mabicalls = 940,                       /* -mabicalls */
  OPT_mad = 941,                             /* -mad */
  OPT_mandroid = 942,                        /* -mandroid */
  OPT_march_ = 943,                          /* -march= */
  OPT_mbionic = 944,                         /* -mbionic */
  OPT_mbranch_cost_ = 945,                   /* -mbranch-cost= */
  OPT_mbranch_likely = 946,                  /* -mbranch-likely */
  OPT_mcheck_zero_division = 947,            /* -mcheck-zero-division */
  OPT_mcode_readable_ = 948,                 /* -mcode-readable= */
  OPT_mdebug = 949,                          /* -mdebug */
  OPT_mdebugd = 950,                         /* -mdebugd */
  OPT_mdivide_breaks = 951,                  /* -mdivide-breaks */
  OPT_mdivide_traps = 952,                   /* -mdivide-traps */
  OPT_mdmx = 953,                            /* -mdmx */
  OPT_mdouble_float = 954,                   /* -mdouble-float */
  OPT_mdsp = 955,                            /* -mdsp */
  OPT_mdspr2 = 956,                          /* -mdspr2 */
  OPT_meb = 957,                             /* -meb */
  OPT_mel = 958,                             /* -mel */
  OPT_membedded_data = 959,                  /* -membedded-data */
  OPT_mexplicit_relocs = 960,                /* -mexplicit-relocs */
  OPT_mextern_sdata = 961,                   /* -mextern-sdata */
  OPT_mfix_r10000 = 962,                     /* -mfix-r10000 */
  OPT_mfix_r4000 = 963,                      /* -mfix-r4000 */
  OPT_mfix_r4400 = 964,                      /* -mfix-r4400 */
  OPT_mfix_sb1 = 965,                        /* -mfix-sb1 */
  OPT_mfix_vr4120 = 966,                     /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 967,                     /* -mfix-vr4130 */
  OPT_mfix4300 = 968,                        /* -mfix4300 */
  OPT_mflip_mips16 = 969,                    /* -mflip-mips16 */
  OPT_mflush_func_ = 970,                    /* -mflush-func= */
  OPT_mfp_exceptions = 971,                  /* -mfp-exceptions */
  OPT_mfp32 = 972,                           /* -mfp32 */
  OPT_mfp64 = 973,                           /* -mfp64 */
  OPT_mfused_madd = 974,                     /* -mfused-madd */
  OPT_mglibc = 975,                          /* -mglibc */
  OPT_mgp32 = 976,                           /* -mgp32 */
  OPT_mgp64 = 977,                           /* -mgp64 */
  OPT_mgpopt = 978,                          /* -mgpopt */
  OPT_mhard_float = 979,                     /* -mhard-float */
  OPT_minterlink_mips16 = 980,               /* -minterlink-mips16 */
  OPT_mips = 981,                            /* -mips */
  OPT_mips16 = 982,                          /* -mips16 */
  OPT_mips3d = 983,                          /* -mips3d */
  OPT_mllsc = 984,                           /* -mllsc */
  OPT_mlocal_sdata = 985,                    /* -mlocal-sdata */
  OPT_mlong_calls = 986,                     /* -mlong-calls */
  OPT_mlong32 = 987,                         /* -mlong32 */
  OPT_mlong64 = 988,                         /* -mlong64 */
  OPT_mmcount_ra_address = 989,              /* -mmcount-ra-address */
  OPT_mmemcpy = 990,                         /* -mmemcpy */
  OPT_mmips_tfile = 991,                     /* -mmips-tfile */
  OPT_mmt = 992,                             /* -mmt */
  OPT_mno_float = 993,                       /* -mno-float */
  OPT_mno_flush_func = 994,                  /* -mno-flush-func */
  OPT_mno_mdmx = 995,                        /* -mno-mdmx */
  OPT_mno_mips16 = 996,                      /* -mno-mips16 */
  OPT_mno_mips3d = 997,                      /* -mno-mips3d */
  OPT_mpaired_single = 998,                  /* -mpaired-single */
  OPT_mplt = 999,                            /* -mplt */
  OPT_mr10k_cache_barrier_ = 1000,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1001,               /* -mrelax-pic-calls */
  OPT_mshared = 1002,                        /* -mshared */
  OPT_msingle_float = 1003,                  /* -msingle-float */
  OPT_msmartmips = 1004,                     /* -msmartmips */
  OPT_msoft_float = 1005,                    /* -msoft-float */
  OPT_msplit_addresses = 1006,               /* -msplit-addresses */
  OPT_msym32 = 1007,                         /* -msym32 */
  OPT_msynci = 1008,                         /* -msynci */
  OPT_mtune_ = 1009,                         /* -mtune= */
  OPT_muclibc = 1010,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1011,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1012,                  /* -mvr4130-align */
  OPT_mxgot = 1013,                          /* -mxgot */
  OPT_n = 1014,                              /* -n */
  OPT_no_canonical_prefixes = 1015,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1016,              /* -no-integrated-cpp */
  OPT_noasmopt = 1017,                       /* -noasmopt */
  OPT_nocpp = 1018,                          /* -nocpp */
  OPT_nodefaultlibs = 1019,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1020,                   /* -nostartfiles */
  OPT_nostdinc = 1021,                       /* -nostdinc */
  OPT_nostdinc__ = 1022,                     /* -nostdinc++ */
  OPT_nostdlib = 1023,                       /* -nostdlib */
  OPT_o = 1024,                              /* -o */
  OPT_p = 1025,                              /* -p */
  OPT_pass_exit_codes = 1026,                /* -pass-exit-codes */
  OPT_pedantic = 1027,                       /* -pedantic */
  OPT_pedantic_errors = 1028,                /* -pedantic-errors */
  OPT_pg = 1029,                             /* -pg */
  OPT_pie = 1030,                            /* -pie */
  OPT_pipe = 1031,                           /* -pipe */
  OPT_posix = 1032,                          /* -posix */
  ...
  OPT_profile = 1043,                        /* -profile */
  OPT_pthread = 1044,                        /* -pthread */
  OPT_quiet = 1045,                          /* -quiet */
  OPT_r = 1046,                              /* -r */
  OPT_rdynamic = 1047,                       /* -rdynamic */
